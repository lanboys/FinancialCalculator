...
public class CalculatorUtil {
    ...
    public static BigDecimal getInvestIncome(BigDecimal money, Long time, BigDecimal annualized_return) {
        ...
        return money.multiply(new BigDecimal(time))
                ...
                .divide(new BigDecimal(365),4, RoundingMode.HALF_DOWN);
    }

    public static BigDecimal getActualAnnualizedReturn(BigDecimal actualMoney, Long actualTime, BigDecimal actualIncome) {
